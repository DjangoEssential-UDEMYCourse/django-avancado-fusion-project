# Generated by Django 3.2.4 on 2021-06-25 17:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado', models.DateField(auto_now=True, verbose_name='Atualizado')),
                ('ativo', models.BooleanField(default=True, verbose_name='Ativo?')),
                ('nome', models.CharField(max_length=100, verbose_name='Equipe')),
                ...
                ('tweeter', models.CharField(default='#', max_length=100, verbose_name='Tweeter')),
